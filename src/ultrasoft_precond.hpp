...
public:
  ...
  auto begin()
  {
    return local::op_iterator<USPreconditioner>(us_precond_base.get_keys(), *this, false);
  }
  auto end()
  {
    return local::op_iterator<USPreconditioner>(us_precond_base.get_keys(), *this, true);
  }
  auto begin() const
  {
    return local::op_iterator<const USPreconditioner>(us_precond_base.get_keys(), *this, false);
  }
  auto end() const
  {
    return local::op_iterator<const USPreconditioner>(us_precond_base.get_keys(), *this, true);
  }
